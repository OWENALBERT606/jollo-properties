                  ...
                  return (
                    <div
                      ...
                      className={`bg-white rounded-2xl border transition-all duration-200 overflow-hidden ${
                        open ? "border-brand-red shadow-sm" : "border-gray-100 hover:border-gray-200"
                      }`}
                    >
                      <button
                        onClick={() => toggle(key)}
                      ...
                      >
                        <span className={`font-semibold text-sm leading-snug ${open ? "text-brand-red" : "text-gray-800"}`}>
                          {item.q}
                        </span>
                        <span className={`shrink-0 rounded-full p-1 transition-colors ${open ? "bg-brand-red text-white" : "bg-gray-100 text-gray-500"}`}>
